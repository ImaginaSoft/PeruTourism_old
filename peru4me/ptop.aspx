<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ptop.aspx.vb" Inherits="etop" %>
					...
					<tr>
						<td colspan="9" valign="middle"><div align="center">
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td width="60%"><font face="Arial, Helvetica, sans-serif" color="#277e49"><b>Sua página de viagem personalizado</b></font></td>
										<td width="40%"><font face="Arial, Helvetica, sans-serif"><b> chamada: (51 1) 241-4724<br>
						    ...
						    <table width="805" border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<td width="175" bgcolor="#e00789"><div align="center">
                                        <asp:hyperlink id="HyperLink1" runat="server" ImageUrl="~/images/go1_por.gif" 
                                            NavigateUrl="javascript:var w=window.open('pformapago.aspx','','width=550,height=580,top=40,left=70,scrollbars=yes,resizeable=yes');"></asp:hyperlink></div>

									
									<td width="0%" rowspan="3" bgcolor="#ffffff"><img src="images/transparent.gif" width="2" height="1"></td>
									<td width="175" bgcolor="#e00789"><div align="center">
                                        <asp:hyperlink id="HyperLink2" runat="server" ImageUrl="~/images/go3_por.gif" 
									...
									<td width="1" rowspan="3" bgcolor="#ffffff"><img src="images/transparent.gif" width="2" height="1"></td>
									<td width="104" rowspan="3" valign="middle" bgcolor="#366ab5"><div align="center">
										<asp:ImageButton id="ImageButton1" runat="server" 
                                            ImageUrl="~/images/visa-1.jpg" Height="43px" Width="72px"></asp:ImageButton>
								    </td>
									<td width="0%" rowspan="3" bgcolor="#ffffff"><img src="images/transparent.gif" width="2" height="1"></td>

									<td width="104" rowspan="3" valign="middle" bgcolor="#f6a51b"><div align="center">
										<asp:ImageButton id="ImageButton2" runat="server" 
                                            ImageUrl="~/images/master-2.jpg" Height="48px" Width="72px"></asp:ImageButton>
									</td>
									<td width="0%" rowspan="3" bgcolor="#ffffff"><img src="images/transparent.gif" width="2" height="1"></td>

									<td width="104" rowspan="3" valign="middle" bgcolor="#f6a51b"><div align="center">
										<asp:ImageButton id="ImageButton3" runat="server" 
                                            ImageUrl="~/images/Paypal-3.gif" Height="49px" Width="72px"></asp:ImageButton>
									</td>
								</tr>
								<tr>
								...
								<tr>
									<td height="19" bgcolor="#e00789"><div align="center">
                                        <asp:hyperlink id="Hyperlink4" runat="server" ImageUrl="~/images/go2_por.gif" 
									...
									<td bgcolor="#e00789"><div align="center"><asp:hyperlink id="HyperLink3" 
                                            runat="server" ImageUrl="~/images/go4_por.gif" 
                                            NavigateUrl="javascript:var w=window.open('pbalance.aspx','','width=650,height=550,top=40,left=70,scrollbars=yes,resizeable=yes');"></asp:hyperlink></div>
									</td>
								</tr>
								<tr height="1">
									...
									<td bgcolor="#ffffff"><img src="images/transparent.gif" width="175" height="1"></td>
									<td bgcolor="#ffffff"><img src="images/transparent.gif" width="1" height="1"></td>
									<td bgcolor="#ffffff"><img src="images/transparent.gif" width="104" height="1"></td>
									<td bgcolor="#ffffff"><img src="images/transparent.gif" width="1" height="1"></td>
									<td bgcolor="#ffffff"><img src="images/transparent.gif" width="104" height="1"></td>
									<td bgcolor="#ffffff"><img src="images/transparent.gif" width="1" height="1"></td>
									<td bgcolor="#ffffff"><img src="images/transparent.gif" width="104" height="1"></td>
