...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        If Not Page.IsPostBack Then
            ...
            'caso ingles
            'https://www.pentagrama.com/perutourism/ilogin.aspx?ID=7501328100723   
            'https://www.pentagrama.com/perutourism/ilogin.aspx?ID=8100624102437  
            'https://www.pentagrama.com/perutourism/ilogin.aspx?ID=220095699988   
            'sParamID = "7974159126098"
            'sParamID = "8073611127617"
            'http://www.pentagrama.com/peru4metest/ilogin.aspx?ID=0635604109945  


            'caso español
            'https://www.pentagrama.com/perutourism/elogin.aspx?ID=2671253102600    
            'https://www.pentagrama.com/perutourism/elogin.aspx?ID=187505314497  
            'https://www.pentagrama.com/perutourism/ilogin.aspx?ID=450265718902   
            'sParamID = "7432457116509                                        "
            'http://svwebcont01/perutourism/ilogin.aspx?ID=3302846112954
    ...
    Private Sub ImageButton1_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImageButton1.Click
        ...
        ValidaEmailClave()
        If Session("CodCliente") = 0 Then
            lblMsg.Text = "Type your e-mail address and password correctly"
    ...
    Private Sub ProgramasPublicados()
        ...
        Else
            objRutina.GrabaLog("Viu " & CStr(ViewState("CantPropuestas")) & " programas publicada", "", Session("CodCliente"), Session("NroPedido"), Session("NroPropuesta"), Session("NroVersion"), Request.UserHostAddress(), "A", lblAccesoDeMozart.Text)
            Response.Redirect("pdefault.htm")
        End If
