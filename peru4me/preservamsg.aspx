<%@ Page Language="VB" AutoEventWireup="false" CodeFile="preservamsg.aspx.vb" Inherits="ereservamsg" %>
			...
			<TABLE id="Table1" 
				...
				<TR>
					<td class="style16" background="images/fondo.gif" colSpan="2" height="60">
						<div align="center"><br>
							<DIV ms_positioning="text2D"><A href="javascript:closeWindow()">Close</A>&nbsp;&nbsp;</DIV>
							<br>
							<br>
