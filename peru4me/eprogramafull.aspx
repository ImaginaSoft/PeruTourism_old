<%@ Page Language="VB" AutoEventWireup="false" CodeFile="eprogramafull.aspx.vb" Inherits="eprogramafull" %>
				...
				<TD>
					<TABLE id="Table2" height="46" cellSpacing="0" cellPadding="0" width="648" border="0">
						<TR>
							...
							<TD>
								<DIV ms_positioning="text2D"><A href="javascript:closeWindow()">Cerrar ventana</A>&nbsp;&nbsp;</DIV>
							</TD>
						</TR>
					</TABLE>
				</TD>
					...
					<TABLE height="481" cellSpacing="0" cellPadding="0" width="632" background="images/fondo_iti.gif"
							...
							<TD vAlign="top" align="center" background="images/fondo_iti_price.gif" colSpan="2"
								...
								<asp:datagrid id="dgPrecio" runat="server" Width="479px" AutoGenerateColumns="False" BorderColor="#888672"
									...
									<Columns>
										...
										<asp:BoundColumn DataField="PrecioxPersona" HeaderText="Precio por pasajero " DataFormatString="{0:USD ###,###,###,###.00}">
											<ItemStyle Wrap="False"></ItemStyle>
										</asp:BoundColumn>
										<asp:BoundColumn DataField="CantPersonas" HeaderText="N&#250;mero de pasajeros">
											<ItemStyle Wrap="False"></ItemStyle>
										</asp:BoundColumn>
						...
						<TR>
							<TD class="style16" background="images/fondo.gif" colSpan="5" height="56">
								<DIV align="center"><BR>
									<SPAN class="style18">Click aquí para conocer 
            acerca de Perú:</SPAN>
