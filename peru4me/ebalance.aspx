<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ebalance.aspx.vb" Inherits="ebalance" %>
				...
				<TR>
					<TD HEIGHT: 36px" class="SubTitInf">
					    ...
					    <table class="style12" width="100%">
                                <tr>
                                    <td>
                                        <DIV align="left"><A  href="javascript:printWindow()">Imprimir página</A></DIV></td>
                                    <td>
                                       <div align="right">
							<A href="javascript:closeWindow()">Cerrar ventana</A></DIV></td>
                                </tr>
                            </table>
				...
				<TR>
						...
						<asp:GridView id="dgBalance" runat="server" Width="600px"  Height="17px" 
							...
							<Columns>
								...
								<asp:BoundField  DataField="Referencia"  HeaderText="Detalle">
									<ItemStyle HorizontalAlign="left" VerticalAlign="Middle"></ItemStyle>
									<HeaderStyle  CssClass = "GridCab"   /> 
								</asp:BoundField >
								<asp:BoundField  DataField="Cargo" HeaderText="Debe" DataFormatString="{0:###,###,###,###.##}">
									<ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" ></ItemStyle>
									<ItemStyle Width="10%" />
									<HeaderStyle  CssClass = "GridCab"   /> 
								</asp:BoundField >
								<asp:BoundField  DataField="Abono" HeaderText="Pago Recibido" DataFormatString="{0:###,###,###,###.##}">
