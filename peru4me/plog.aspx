<%@ Page Language="VB" AutoEventWireup="false" CodeFile="plog.aspx.vb" Inherits="plog" %>
...
<head runat="server">
	...
	<BODY>
		...
		<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="552" border="0" background="images/fondo_iti.gif">
				...
				<td class="style12" colSpan="2" height="56">
					<asp:datagrid id="dglog" runat="server" HeaderStyle-CssClass="GridHeader" CssClass="style12" AutoGenerateColumns="False"
						...
						<Columns>
							...
							<asp:BoundColumn DataField="DesLog" HeaderText="Mensagem"></asp:BoundColumn>
			...
			<TR>
				<TD borderColor="#ff6633" align="center"><a href="javascript:closeWindow()">Fechar janela</a></TD>
			</TR>
		</TABLE>
    </form>
</body>
