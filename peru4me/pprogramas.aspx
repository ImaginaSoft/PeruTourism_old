<%@ Page Language="VB" AutoEventWireup="false" CodeFile="pprogramas.aspx.vb" Inherits="eprogramas" %>
							...
							<TABLE cellSpacing="0" cellPadding="0" width="640" 
								...
								<TR>
									<TD class="style26" height="8"><asp:datagrid id="dgPublica" runat="server" HeaderStyle-CssClass="GridHeader" AutoGenerateColumns="False"
											...
											<Columns>
												<asp:HyperLinkColumn Text="&lt;img src=images/lupagris.gif&gt;" DataNavigateUrlField="KeyReg" DataNavigateUrlFormatString="pprograma.aspx?ID={0}"></asp:HyperLinkColumn>
												...
												<asp:HyperLinkColumn  DataTextField="DesPrograma" HeaderText="descrição" DataNavigateUrlField="KeyReg" DataNavigateUrlFormatString="pprograma.aspx?ID={0}"></asp:HyperLinkColumn>
												<asp:BoundColumn DataField="CantDias" HeaderText="N&#250;mero de dias ">
								...
								<TR>
									<TD class="style16" background="images/fondo.gif" height="56">
										<DIV align="center"><BR><BR><BR><BR><BR><BR>
											...
											<BR>
											<BR>
											Deixe-nos saber seus comentários <A href="mailto:peru@perutourism.com">peru@perutourism.com</A>.<BR>
