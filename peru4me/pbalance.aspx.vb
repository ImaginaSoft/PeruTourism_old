...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not Page.IsPostBack Then
            lblNomCliente.Text = "Balance de " & Session("NomCliente")
            CargaDocumentos()
        End If
    End Sub
    ...
    Private Sub CargaDocumentos()
        ...
        If nReg = 0 Then
            lblMsg.Text = "Nós ainda não recebeu o pagamento antecipado do passeio você preferir. Lembre-se que estamos disponíveis para ajudá-lo a viver a experiência única que é visitar Peru , Terra dos Incas."
            sMsgLog = "Conta corrente - falta prepago "
        Else
            dgBalance.DataSource = ds
            dgBalance.DataBind()
            sMsgLog = "Conta corrente "
        End If
    ...
    '        ' e.Item.Cells(2).Text = String.Format("{0,12:2;(###,###,###,###.00)}", wTotalSum)
    ...
    '        e.Item.Cells(2).Text = String.Format("{0:###,###,###,###.00}", wTotalSum)
    '        e.Item.Cells(2).HorizontalAlign = HorizontalAlign.Right

    '        e.Item.Cells(4).Text = String.Format("{0:###,###,###,###.00}", wSaldoSum)
    ...
    '        Else
    '            e.Item.Cells(1).Text = "Balance Pendiente US$ "
    ...
    Protected Sub dgBalance_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles dgBalance.RowDataBound
        ...
        ElseIf e.Row.RowType = DataControlRowType.Footer Then
            ...
            lblTotal.Text = "SALDO PENDENTE US$ " & wSaldo.ToString
        End If
