<%@ Page Language="VB" AutoEventWireup="false" CodeFile="eprograma.aspx.vb" Inherits="eprograma" %>
			...
			<form id="Form1" method="post" runat="server">
				<TABLE height="1382" cellSpacing="0" cellPadding="0" width="642" border="0" ms_2d_layout="TRUE">
					...
					<TR vAlign="top">
						...
						<TD colSpan="2" rowSpan="2">
							<TABLE cellSpacing="0" cellPadding="0" width="640" background="images/fondo_iti.gif" border="0"
								...
								<TR>
									<td colSpan="2" height="7" align="right"><asp:hyperlink id="HyperlinkPrint" runat="server" NavigateUrl="javascript:var w=window.open('eprogramafull.aspx','','width=680,height=490,top=20,left=70,scrollbars=yes,resizeable=yes');"
								...
								<TR>
									...
									<asp:datagrid id="dgItinerary" runat="server" HeaderStyle-CssClass="GridHeader" GridLines="None"
											...
											<Columns>
												...
												<asp:BoundColumn DataField="HoraServicio" SortExpression="HoraServicio" HeaderText="HORA">
													<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
										...
										<TABLE height="102" cellSpacing="0" cellPadding="0" width="649" background="images/fondo_iti.gif"
											...
											<TR>
												<TD vAlign="top" width="647" height="15">
													<DIV class="style21" align="left"><U>ESTE PROGRAMA DE PERU-TURISMO OFRECE :</U></DIV>
												</TD>
											</TR>
											<TR>
											...
											<TR>
												<TD vAlign="top" align="left" width="647" height="15">
													<DIV class="style21"><U>DETALLLES EXCLUSIVOS:</U>
													</DIV>
												</TD>
											</TR>
											<TR>
										...
										<TABLE id="Table3" height="28" cellSpacing="0" cellPadding="0" width="649" background="images/fondo_iti.gif"
											...
											<TR class="style12">
												<TD width="440" background="images/fondo_iti_tit.gif" colSpan="3" height="20">
													<DIV align="left"><STRONG>HOTELES SELECCIONADOS</STRONG>&nbsp;</DIV>
												</TD>
												<TD width="200" borderColor="#888672" borderColorLight="#888672" background="images/fondo_iti_tit.gif"
													...
													<DIV align="left"><STRONG>COMIDAS&nbsp;INCLUIDAS</STRONG></DIV>
												</TD>
											</TR>
											<TR>
								...
								<TR class="style12">
									<TD background="images/fondo_iti_tit.gif" colSpan="2">
										<DIV align="center"><STRONG>PRECIO EN DOLARES AMERICANOS</STRONG></DIV>
									</TD>
								</TR>
								<TR>
									<TD vAlign="top" bgColor="#888672" colSpan="2" height="1"><IMG src="transparent.gif"></TD>
								...
								<TR>
									<TD vAlign="top" background="images/fondo_iti_price.gif" colSpan="2" height="90">
										<DIV align="center">&nbsp;
											<asp:datagrid id="dgPrecio" runat="server" AutoGenerateColumns="False" Width="476px" ShowFooter="True"
												...
												<Columns>
													...
													<asp:BoundColumn DataField="PrecioxPersona" HeaderText="Precio por pasajero " DataFormatString="{0:USD ###,###,###,###.##}">
														<ItemStyle Wrap="False"></ItemStyle>
													</asp:BoundColumn>
													<asp:BoundColumn DataField="CantPersonas" HeaderText="N&#250;mero de pasajeros" DataFormatString="{0:###}">
														<ItemStyle Wrap="False"></ItemStyle>
													</asp:BoundColumn>
													<asp:BoundColumn DataField="PrecioTotal" HeaderText="Precio total " DataFormatString="{0:USD ###,###,###,###.00}">
														<ItemStyle Wrap="False"></ItemStyle>
										...
										&nbsp;
										<asp:label id="lblEuro" runat="server" Width="462px" ForeColor="Blue" Font-Size="Small"> X,XXX.XX US$  equivale a <b>
								...
								<TR class="style12">
									<TD background="images/fondo_iti_tit.gif" colSpan="2">
										<DIV align="center"><A name="SendEmailOK"><STRONG>COMMUNICACIÓN</STRONG></DIV>
										</A></TD>
								</TR>
								<TR>
									<TD vAlign="top" bgColor="#888672" colSpan="2" height="1"><IMG src="transparent.gif"></TD>
								...
								<TR>
									...
									<TD vAlign="top" width="14%" background="images/fondo_iti.gif" rowSpan="2">
										<DIV align="left"><asp:image id="ImgFotoVendedor" runat="server" Width="68px" Height="52px"></asp:image><BR>
											...
											<BR>
											<BR>
											<asp:hyperlink id="HyperLinkLog" runat="server" Width="40px" Height="31px" NavigateUrl="javascript:var w=window.open('elog.aspx','', 'width=600,height=500,top=20,left=100,scrollbars=yes,resizeable=yes');"
												ImageUrl="images/buzon.gif"></asp:hyperlink><BR>
											<SPAN class="style17">Historial de comunicaciones</SPAN><BR>
										</DIV>
									</TD>
								</TR>
								<TR class="style15">
								...
								<TR>
									<TD class="style16" width="663" background="images/fondo.gif" colSpan="2" height="16">
										<asp:Label id="lblAutorizaVisa" runat="server" class="style18">Esta tienda está autorizada por Visa y MasterCard para realizar transacciones electrónicas.</asp:Label></TD>
								</TR>
								<TR>
                  ...
                  Perú:</SPAN>
								...
								<TR>
									<TD class="style16" background="images/fondo.gif" colSpan="2" height="10"></TD>
								</TR>
							</TABLE>
						</TD>
					</TR>
