...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        If Session("CodCliente") = 0 Then
            Response.Redirect("pfinsesion.aspx")
        End If
    ...
    Private Sub Propuesta()
        ...
        Try
            ...
            Do While dr.Read()
                ...
                lblNomCliente.Text = "Itinerário personalizado para " & Session("NomCliente")
                'Propuesta
                ...
                lblSendVendedor.Text = "Enviar uma mensagem para o seu especialista " & dr.GetValue(dr.GetOrdinal("NomVendedor")) & "</span>"
                ...
                If dr.GetValue(dr.GetOrdinal("BlogVendedor")) <> "" Then
                    lblBlog.Text = lblBlog.Text & _
                            ...
                            "Mais sobre mim Clique aqui" & "</a></div>"
                End If
    ...
    Private Sub ImageButtonSend_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImageButtonSend.Click
        ...
        If Trim(lblMsg.Text) = "OK" Then
            ...
            Response.Redirect("pprograma.aspx#SendEmailOK")
        End If
    End Sub
