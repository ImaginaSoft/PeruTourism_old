...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not Page.IsPostBack Then
            lblNomCliente.Text = "Reserva do Estado " & Session("NomCliente")

            lblMsg.Text = "ós ainda não recebeu o pagamento antecipado do passeio você preferir. Lembre-se que estamos disponíveis para ajudá-lo a viver a experiência única que é visitar Peru , Terra dos Incas."
        End If
    End Sub
