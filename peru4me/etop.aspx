            ...
            <table width="805" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td width="170" rowspan="2">
                        <img src="images/logo2.gif" width="170" height="78"></td>
                    <td width="585" colspan="9" valign="top">
                        <img src="images/franja.gif" width="635" height="35" align="left"></td>
                </tr>
                <tr>
                    ...
                    <td colspan="10">
                        <table width="805" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td width="1" rowspan="3" bgcolor="#ffffff">
                                    <img src="images/transparent.gif" width="2" height="1"></td>
                    </td>
                    <td width="175" bgcolor="#e00789">
                        <div align="center">
                            ...
                            <asp:HyperLink ID="HyperLink1" runat="server" ImageUrl="~/images/go1_esp.gif"
                                NavigateUrl="javascript:var w=window.open('eformapago.aspx','','width=550,height=580,top=40,left=70,scrollbars=yes,resizeable=yes');"></asp:HyperLink>
                        </div>


                        <td width="0%" rowspan="3" bgcolor="#ffffff">
                            <img src="images/transparent.gif" width="2" height="1"></td>
                        <td width="175" bgcolor="#e00789">
                            <div align="center">
                                <asp:HyperLink ID="HyperLink2" runat="server" ImageUrl="images/go3_esp.gif"
                                    NavigateUrl="javascript:var w=window.open('reserva.aspx','','width=700,height=580,top=40,left=70,scrollbars=yes,resizeable=yes');"></asp:HyperLink>
                            </div>
                        </td>
                        <td width="1" rowspan="3" bgcolor="#ffffff">
                            <img src="images/transparent.gif" width="2" height="1"></td>
                        <td width="162" rowspan="3" valign="bottom" bgcolor="#366ab5">
                           <%-- <asp:ImageButton ID="ImageButton1" runat="server"
                                ImageUrl="~/images/pagolink.png" Style="margin-bottom: 0px"></asp:ImageButton>--%>
                            <a title="VisaLink" href="https://www.visanetlink.pe/pagoseguro/PERUTOURISM/26688" target="_blank"><img src="images/pagolink.gif" alt="VisaLink" /></a>

                        </td>
                        <td width="0%" rowspan="3" bgcolor="#ffffff">
                            <img src="images/transparent.gif" width="2" height="1"></td>

                        <td width="151" rowspan="3" valign="middle" bgcolor="#f6a51b">
                            <div align="center">
                                <%--<asp:ImageButton ID="ImageButton2" runat="server"
                                    ImageUrl="~/images/mc_accpt_050_gif.gif"></asp:ImageButton>--%>
                                <asp:Label ID="Label1" runat="server" CssClass="descripcion">Tu Código de cliente : </asp:Label>
                    ...
                    <td height="19" bgcolor="#e00789">
                        <div align="center">
                            ...
                            <asp:HyperLink ID="Hyperlink4" runat="server" ImageUrl="~/images/go2_esp.gif"
                                NavigateUrl="javascript:var w=window.open('informacion.aspx','','width=650,height=640,top=3,left=70,scrollbars=yes,resizeable=yes');"></asp:HyperLink>
                        </div>
                    </td>
                    <td bgcolor="#e00789">
                        <div align="center">
                            <asp:HyperLink ID="HyperLink3"
                                ...
                                NavigateUrl="javascript:var w=window.open('ebalance.aspx','','width=650,height=550,top=40,left=70,scrollbars=yes,resizeable=yes');"></asp:HyperLink>
                        </div>
                    </td>
                </tr>
                <tr height="1">
                    <td bgcolor="#ffffff">
                        <img src="images/transparent.gif" width="134" height="1"></td>
                    <td bgcolor="#ffffff">
                        <img src="images/transparent.gif" width="1" height="1"></td>
                    <td bgcolor="#ffffff">
                        <img src="images/transparent.gif" width="175" height="1"></td>
                    <td bgcolor="#ffffff">
                        <img src="images/transparent.gif" width="1" height="1"></td>
                    <td bgcolor="#ffffff">
                        <img src="images/transparent.gif" width="175" height="1"></td>
                    <td bgcolor="#ffffff">
                        <img src="images/transparent.gif" width="1" height="1"></td>
                    <td bgcolor="#ffffff">
                        <img src="images/transparent.gif" width="162" height="1"></td>
                    <td bgcolor="#ffffff">
                        <img src="images/transparent.gif" width="1" height="1"></td>
                    <td bgcolor="#ffffff">
                        <img src="images/transparent.gif" width="151" height="1"></td>
                </tr>
            </table>
            </td>
					</tr>
