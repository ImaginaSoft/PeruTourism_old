<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ilog.aspx.vb" Inherits="ilog" %>
			...
			<TR>
				<td class="style12" colSpan="2" height="56">
					<asp:datagrid id="dglog" runat="server" HeaderStyle-CssClass="GridHeader" CssClass="style12" AutoGenerateColumns="False"
						...
						<Columns>
							<asp:BoundColumn DataField="Fchsys" HeaderText="Date" DataFormatString="{0,1:dd MMM yyyy}{0,13:hh:mm tt }">
								<HeaderStyle VerticalAlign="Top"></HeaderStyle>
							</asp:BoundColumn>
							<asp:BoundColumn DataField="DesLog" HeaderText="Message"></asp:BoundColumn>
							<asp:BoundColumn DataField="Autor" HeaderText="Author"></asp:BoundColumn>
							<asp:BoundColumn Visible="False" DataField="TipoLog" HeaderText="TipoLog"></asp:BoundColumn>
						</Columns>
					</asp:datagrid></td>
			</TR>
			<TR>
				<TD borderColor="#ff6633" align="center"><a href="javascript:closeWindow()">Close 
						window</a></TD>
			</TR>
		</TABLE>
</body>
