...
#End Region
    ...
    Private Sub Propuesta()
        ...
        Try
            ...
            Do While dr.Read()
                ...
                'lblNomCliente.Text = Trim(dr.GetValue(dr.GetOrdinal("Nombre")))
                'End If
                ...
                'Session("NomCliente") = lblNomCliente.Text

                lblNomCliente.Text = "Personalized itinerary for " & Session("NomCliente")
                'Propuesta
                ...
                lblSendVendedor.Text = "Send a message to your travel specialist " & dr.GetValue(dr.GetOrdinal("NomVendedor")) & "</span>"
                ...
                If dr.GetValue(dr.GetOrdinal("BlogVendedor")) <> "" Then
                    lblBlog.Text = lblBlog.Text & _
                            ...
                            "More about me Click here" & "</a></div>"
                End If
            Loop
            dr.Close()
        Finally
        ...
        If ViewState("GrabaLog") = "SI" Then
            objRutina.GrabaLog("Proposal", "", Session("CodCliente"), Session("NroPedido"), Session("NroPropuesta"), 0, Request.UserHostAddress(), "A", "N")
        End If
    End Sub
    ...
    Private Sub Version()
        ...
        Dim wTotalAdulto, wTotalNino, wTotalInfante, wTotalSenior As Double
        ...
        'VerLinks()
        If ViewState("GrabaLog") = "SI" Then
            objRutina.GrabaLog("Version", "", Session("CodCliente"), Session("NroPedido"), Session("NroPropuesta"), Session("NroVersion"), Request.UserHostAddress(), "A", "N")
        End If
    ...
    Sub ComputeSum(ByVal sender As Object, ByVal e As DataGridItemEventArgs)
        ...
        ElseIf e.Item.ItemType = ListItemType.Footer Then
            ...
            If lblFlagPublicaEuro.Text = "S" Then
                lblEuro.Text = "<br>" & e.Item.Cells(3).Text & " are equivalent to <b>" & _
    ...
    Private Sub ImageButtonSend_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImageButtonSend.Click
        ...
        If Trim(lblMsg.Text) = "OK" Then
            ...
            With email
                ...
                .Subject = "Peru4me - Proposals " & RTrim(Session("NroPropuesta")) & " " & Session("NombrePaterno")
            ...
            txtComentario.Text = ""
            Session("Opcion") = 1
            Session("StsSendEmail") = "Message was send to successful"
            Response.Redirect("iprograma.aspx#SendEmailOK")
        End If
    End Sub
